"""shopping_hard_or_hardly_shopping URL Configuration
...
from shopping_hard_or_hardly_shopping import settings
...
urlpatterns = [
    ...
    url(r'^shopping_type_detection/$', remoteuser.shopping_type_detection, name="shopping_type_detection"),
    ...
    url(r'^View_Prediction_Of_Shopping_Type_Ratio/$', serviceprovider.View_Prediction_Of_Shopping_Type_Ratio, name="View_Prediction_Of_Shopping_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Shopping_Type_Details/$', serviceprovider.View_Prediction_Of_Shopping_Type_Details, name="View_Prediction_Of_Shopping_Type_Details"),
