...
ROOT_URLCONF = 'shopping_hard_or_hardly_shopping.urls'
...
WSGI_APPLICATION = 'shopping_hard_or_hardly_shopping.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'shopping_hard_or_hardly_shopping',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
