...
--
-- Database: `shopping_hard_or_hardly_shopping`
--
CREATE DATABASE IF NOT EXISTS `shopping_hard_or_hardly_shopping` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `shopping_hard_or_hardly_shopping`;
...
('9ljqi7vyu5rhgbxkvqeg5xgonzbtfcn3', 'eyJ1c2VyaWQiOjZ9:1qmDuK:7My2S-KnRloPI4Y75JibM56hKBXweFGRKnjPbNJA65E', '2023-10-13 13:51:52.092435'),
...
('knirqlygfyk0vxmixbek57gkhbczyr2z', 'eyJ1c2VyaWQiOjN9:1pRtdU:0Flqfdj6nq5m6CmxOf83UNVM2jee5FllZfiUsMDrMbY', '2023-02-28 11:38:12.466229'),
('lilq6ir2hd7bbtfi0ujqgxc2yjq9l9p6', 'eyJ1c2VyaWQiOjR9:1pRv5M:Ge0ljVh7PUxDr76xDZWhGbCoSC8x6hwMTlBxmLagrFY', '2023-02-28 13:11:04.647366'),
...
('turg1cap396nh9ak07z0xw4bnqbswen0', 'eyJ1c2VyaWQiOjV9:1qmDIv:KeRGEi6H-3P5Orw-fp005hTJf8lLCKu3jN3GWLoAoyo', '2023-10-13 13:13:13.983365'),
...
(5, 'Kumaresh', 'Kumaresh123@gmail.com', 'Kumaresh', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male'),
(6, 'Manjunath', 'tmksmanju14@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male');
...
(13, 'Logistic Regression', '64.68253968253968'),
(14, 'Decision Tree Classifier', '63.49206349206349'),
(15, 'SVM', '66.66666666666666'),
(16, 'KNeighborsClassifier', '69.04761904761905'),
(17, 'Gradient Boosting Classifier', '67.06349206349206'),
(18, 'Random Forest Classifier', '67.46031746031747');
...
(14, 'Shopping Hard', '60.0'),
(15, 'Hardly Shopping ', '40.0');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_predict_shopping_type`
--

CREATE TABLE IF NOT EXISTS `remote_user_predict_shopping_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `product_ID` varchar(3000) NOT NULL,
  `product_type` varchar(3000) NOT NULL,
  `product_name` varchar(3000) NOT NULL,
  `psize` varchar(3000) NOT NULL,
  `colour` varchar(3000) NOT NULL,
  `invoice_no` varchar(3000) NOT NULL,
  `customer_id` varchar(3000) NOT NULL,
  `gender` varchar(3000) NOT NULL,
  `age` varchar(3000) NOT NULL,
  `quantity` varchar(3000) NOT NULL,
  `price` varchar(3000) NOT NULL,
  `payment_method` varchar(3000) NOT NULL,
  `invoice_date` varchar(3000) NOT NULL,
  `shopping_mall` varchar(3000) NOT NULL,
  `clickstream_data` varchar(3000) NOT NULL,
  `Prediction` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=6 ;

--
-- Dumping data for table `remote_user_predict_shopping_type`
--

INSERT INTO `remote_user_predict_shopping_type` (`id`, `product_ID`, `product_type`, `product_name`, `psize`, `colour`, `invoice_no`, `customer_id`, `gender`, `age`, `quantity`, `price`, `payment_method`, `invoice_date`, `shopping_mall`, `clickstream_data`, `Prediction`) VALUES
(1, '157.240.2.35-10.42.0.151-443-34508-6', 'Shirt', 'Oxford Cloth', 'L', 'red', 'I173702', 'C988172', 'Female', '66', '5', '3000.85', 'Credit Card', '16-05-21', 'Metropol AVM', 'A red coloured, L sized, Oxford Cloth Shirt', 'Hardly Shopping'),
(2, '172.217.12.174-10.42.0.42-443-55995-6', 'Shirt', 'Oxford Cloth', 'XS', 'orange', 'I227836', 'C657758', 'Female', '28', '5', '1500.4', 'Credit Card', '24-05-22', 'Forum Istanbul', 'A orange coloured, XS sized, Oxford Cloth Shirt', 'Shopping Hard'),
(3, '172.217.7.163-10.42.0.42-443-40747-6', 'Shirt', 'Oxford Cloth', 'S', 'orange', 'I121056', 'C151197', 'Female', '49', '1', '40.66', 'Cash', '13-03-22', 'Istinye Park', 'A orange coloured, S sized, Oxford Cloth Shirt', 'Shopping Hard'),
(4, '10.42.0.151-103.7.30.118-60374-80-6', 'Shirt', 'Oxford Cloth', 'XL', 'orange', 'I326945', 'C283361', 'Female', '60', '2', '600.16', 'Credit Card', '22-08-21', 'Kanyon', 'A orange coloured, XL sized, Oxford Cloth Shirt', 'Shopping Hard'),
(5, '10.42.0.211-47.93.77.90-38810-443-6', 'Shirt', 'Denim', 'S', 'indigo', 'I129886', 'C846730', 'Female', '42', '5', '26.15', 'Cash', '25-10-21', 'Metrocity', 'A indigo coloured, S sized, Denim Shirt', 'Hardly Shopping');
